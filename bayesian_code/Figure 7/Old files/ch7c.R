...
## Subsetting the values we'll use in our NIMBLE model:
## Encounter data
y = data.ch7c$encounter.data
...
# that were detected)
M = 9000 # Note that the true N (true population size) is 7451
...
mona.densities = mona.densities[,"Dgood"]
