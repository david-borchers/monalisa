## Creating RData object for ch7b
#setwd("..")
...
## ch7b
# Encounter matrix
ch7b = capthists_expected_acd_many$capthist[1][[1]]
...
# Data object
data.ch7b = list(encounter.data = encounterdat.ch7b, trap.loc = ch7b.traploc)
...
# We want to subset the 'Dgood_bigD' column from the resulting data frame, as this contains the values for our chosen covariate here. We also are subsetting the x- and y-coordinate columns (these give the pixel centres that correspond to each covariate value)
...
## Fitting the model
ch7b.sample = run.MCMC.inhom(data=data.ch7b, pixel.info=pixel.info, x.pixels=50, y.pixels=50, M=9000, inits.vec=c(10, 4, 0), n.iter=100, n.burn=10)
