...
#ch7b.density = (ch7b.beta0 + (ch7b.beta1 * (dgood)))

# ch7c
ch7c.density = exp(ch7c.beta0 + (ch7c.beta1 * log(dgood)))
#ch7c.density = (ch7c.beta0 + (ch7c.beta1 * (dgood)))

# ch7e
ch7e.density = exp(ch7e.beta0 + (ch7e.beta1 * log(dblur)))
#ch7e.density = (ch7e.beta0 + (ch7e.beta1 * (dblur)))

# ch7f
ch7f.density = exp(ch7f.beta0 + (ch7f.beta1 * log(dblur)))
#ch7f.density = (ch7f.beta0 + (ch7f.beta1 * (dblur)))
