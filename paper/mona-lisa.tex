...
After simulating these capture histories for these arrays, we  created an estimated AC surface for each simulation. In this scenario we assumed a model with constant density and compared the resulting estimated realised activity center surface to the true population density surface (the Mona Lisa).
...
\subsubsection{Estimated realised AC densities with many activity centers}
...
\subsubsection{Estimated realised AC densities with few activity centers}
