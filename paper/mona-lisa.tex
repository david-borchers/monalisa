...
\todo[inline]{Throughout this paragraph I find the word ``which'' a little unnatural. For passages like ``Alexander et al (2015), which presents a map...'', I always consider the subject to be the authors, rather than the manuscript. So  I'd change this to ``Alexander et al (2015), who presents a map...''. I haven't changed anything because I'm not sure if it's normal to use ``which'' in this content; if so, ignore this comment!}
