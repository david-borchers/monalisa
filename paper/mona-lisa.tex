...
DB and BS conceived the initial idea. ID, RP and DB designed the Mona Lisa simulations. RP implemented an earlier version of the maximum likelihood simulations; ID implemented the later version appearing in the paper and analysed the Nagarahole data. RC and BS implemented the Mona Lisa simulations using Bayesian methods. BS conceived of usage density surfaces and developed the theory describing these. KS provided guidance on misinterpretation and feedback on proposed guidelines. DB, ID, BS and RC wrote the paper. All authors contributed critically to the drafts and gave final approval for publication.
